...
namespace Client.World.Network
{
    public partial class WorldSocket : GameSocket
    {
        static HashSet<WorldCommand> IgnoredOpcodes = new HashSet<WorldCommand>()
        {
            ...
            WorldCommand.SMSG_BIND_POINT_UPDATE,
            ...
            WorldCommand.SMSG_SPLINE_MOVE_GRAVITY_DISABLE,
            WorldCommand.SMSG_SPLINE_MOVE_GRAVITY_ENABLE,
